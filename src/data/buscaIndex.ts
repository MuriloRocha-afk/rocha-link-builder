...
const tintas: ItemBusca[] = [
  {
    ...
    nome: "Tinta Acrílica",
    categoria: "Tintas",
    rota: "/catalogo/tintas/tinta-acrilica",
    termos: ["tinta", "acrilica", "tinta de parede", "tinta de telha", "pintura"],
  },
  {
    id: "esmalte",
    nome: "Esmalte Sintético",
    categoria: "Tintas",
    rota: "/catalogo/tintas/esmalte",
    termos: ["esmalte", "tinta de metal", "tinta sintetica"],
  },
  {
    id: "verniz",
    nome: "Verniz",
    ...
    termos: ["verniz", "verniz maritimo", "acabamento de madeira"],
  },
  {
    id: "stain",
    nome: "Stain para Madeira",
    categoria: "Tintas",
    rota: "/catalogo/tintas/stain",
    termos: ["stain", "osmocolor", "protecao de madeira", "deck"],
  },
  {
    id: "cupicida",
    nome: "Cupinicida",
  ...
  },
  {
    ...
    nome: "Seladora",
    categoria: "Tintas",
    rota: "/catalogo/tintas/seladora",
    termos: ["seladora", "fundo preparador"],
  },
  {
    id: "pu-calha",
    nome: "PU para Calha",
  ...
  },
  {
    ...
    nome: "Thinner",
    categoria: "Tintas",
    rota: "/catalogo/tintas/thinner",
    termos: ["thinner", "solvente", "diluente"],
  },
  {
    id: "aguarras",
    nome: "Aguarrás",
    ...
    termos: ["aguarras", "solvente", "diluente"],
  },
  {
    id: "lixas",
    nome: "Lixas",
