...
export const TELHAS_CATALOGO: TelhaCatalogo[] = [
  ...
  { id: "cer-medit", label: "Mediterrânea (TopTelha)", grupo: "Cerâmica de Barro", fabricante: "TopTelha", href: CERAMICA, rendimento: 13, min: 30, familia: "ceramica", pesoM2: 39, pesoPeca: 3, galga: "35,6 cm", chavePreco: "telha.cer-romana", confirmado: true, notaDados: "Inclinação de 30% vale para água de até 3 m — acima disso, ver tabela TopTelha.", usoCobertura: true, cumeeira: CUM_BARRO, espigao: ESP_BARRO },
