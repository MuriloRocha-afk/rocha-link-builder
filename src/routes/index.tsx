        ...
        <section id="inicio" className="relative flex min-h-[92vh] items-center overflow-hidden pt-24">
          ...
          <div className="relative mx-auto w-full max-w-7xl px-5 py-20">
            <div className="max-w-4xl">
              ...
              <h1 className="hero-title mt-6 text-4xl leading-[1.05] font-black text-primary-foreground md:text-6xl lg:text-7xl">
                <span className="block">A Maior Variedade em</span>
                <span className="block text-gradient-accent-deep">
                  Telhas e Madeiramento Nobre
                </span>
                <span className="block">da Região</span>
              </h1>
