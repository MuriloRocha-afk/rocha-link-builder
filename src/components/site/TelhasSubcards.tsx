...
import fibrocimentoAsset from "@/assets/produtos/capas/02_capa_fibrocimento.jpg.asset.json";
import concretoAsset from "@/assets/produtos/capas-iniciais-telhas/02_capa_telha_concreto.jpg.asset.json";
import petAsset from "@/assets/produtos/capas-iniciais-telhas/03_capa_telha_pet_translucida.jpg.asset.json";
import planPvcAsset from "@/assets/produtos/capas-iniciais-telhas/01_capa_telha_plan_pvc.jpg.asset.json";
import policarbonatoAsset from "@/assets/produtos/capas/04_capa_policarbonato.jpeg.asset.json";
import colonialPvcAsset from "@/assets/produtos/capas/04_capa_colonial_pvc.jpg.asset.json";
import polipropilenoAsset from "@/assets/produtos/capas/05_capa_polipropileno.jpeg.asset.json";
import esmaltadaAsset from "@/assets/produtos/capas-iniciais-telhas/05_capa_telha_esmaltada.jpg.asset.json";
import vidroAsset from "@/assets/produtos/capas-iniciais-telhas/04_capa_telha_vidro.jpg.asset.json";
...
const planPvc = planPvcAsset.url;
const policarbonato = policarbonatoAsset.url;
const colonialPvc = colonialPvcAsset.url;
const polipropileno = polipropilenoAsset.url;
const esmaltada = esmaltadaAsset.url;
const vidro = vidroAsset.url;
